    ...
    <div className="container">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {services.map((service, index) => (
          <Card key={index} className={`text-left p-6 flex flex-col items-start shadow-lg rounded-xl ${service.featured ? 'bg-primary text-primary-foreground' : 'bg-card'}`}>
            ...
            <Button variant={service.featured ? 'secondary' : 'default'} className="mt-6 w-full">
              {service.featured ? 'Cenová ponuka' : 'Naše služby'}
            </Button>
          </Card>
        ))}
      </div>
...
const WhyUsSection = () => (
  <section id="preco-my" className="py-16 md:py-24 bg-muted/20 text-foreground">
...
const FaqSection = () => (
    <section id="faq" className="py-16 md:py-24 bg-muted/20 text-foreground">
  ...
  <section className="bg-secondary text-secondary-foreground">
    <div className="container py-16 md:py-20 text-center">
      ...
      <Link href="/contact" passHref>
        <Button size="lg" variant="default" className="px-8 py-6 text-lg transition-colors duration-300 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full">
