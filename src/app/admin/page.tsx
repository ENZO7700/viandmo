...
const stats = [
    { title: "Today's Revenue", value: "$2,450", change: "+15.2%", icon: <DollarSign className="h-4 w-4 text-muted-foreground"/> },
    { title: "Today's Bookings", value: "18", change: "+5", icon: <Calendar className="h-4 w-4 text-muted-foreground"/> },
    { title: "New Customers", value: "4", change: "+1", icon: <Users className="h-4 w-4 text-muted-foreground"/> },
]
                    ...
                    <Card key={stat.title}>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground flex items-center">
                                ...
                                <span className="text-green-500 mr-1">{stat.change}</span> from yesterday
                            </p>
                        </CardContent>
                    </Card>
                ))}
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>A list of the most recent appointments.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                             <TableHeader>
