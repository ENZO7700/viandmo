  ...
  return (
    ...
    >
      <motion.div
        ...
        className="lg:col-span-2 bg-card/60 backdrop-blur-md rounded-2xl shadow-2xl shadow-black/20 border border-white/10"
      >
        <Card className="bg-transparent border-0">
            ...
            <CardContent className="space-y-8 px-8 pb-8">
                ...
                <motion.div variants={itemVariants} className="space-y-4 p-6 rounded-xl bg-muted/20 border border-white/5">
