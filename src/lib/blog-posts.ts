...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <h3 className="font-headline text-2xl mt-4">1. Skontrolujte si referencie a recenzie</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">2. Transparentná cenová ponuka je základ</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">3. Poistenie zodpovednosti za škodu</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">4. Rozsah ponúkaných služieb</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">5. Komunikácia a prístup</h3>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <h3 className="font-headline text-2xl mt-4">1. Podcenenie prípravy a balenia</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">2. Zlé plánovanie parkovania v Bratislave</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">3. Snaha ušetriť na nesprávnych miestach</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">4. Neefektívne triedenie a vypratávanie</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">5. Zabudnutie na administratívne úkony</h3>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <h3 className="font-headline text-2xl mt-4">1. Parkovanie: Plánujte vopred!</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">2. Výťah je váš najlepší priateľ (alebo nepriateľ)</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">3. Logistika na poschodí</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">4. Využite služby vypratávania</h3>
        ...
        <h3 className="font-headline text-2xl mt-4">5. Dôverujte profesionálom so skúsenosťami</h3>
